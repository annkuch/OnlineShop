...
import com.kucheruk.domain.dto.CaptchaResponseDto;
...
public class RegistrationController {
    ...
    public String registration(
        ...
        if (isConfirmEmpty) {
            model.addAttribute("password2Error", "Підтвердження пароля не може бути порожнім");
        }
    ...
    public String activateEmailCode(@PathVariable String code, Model model) {
        ...
        if (isActivated) {
            ...
            model.addAttribute("message", "Користувач успішно активовано");
