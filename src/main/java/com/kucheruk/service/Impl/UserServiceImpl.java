...
import com.kucheruk.domain.Role;
import com.kucheruk.domain.User;
import com.kucheruk.repos.UserRepository;
    ...
    public void sendMessage(User user) {
        if (!StringUtils.isEmpty(user.getEmail())) {
            String message = String.format("Привіт, %s! \n " +
                    "Ласкаво просимо до інтернет магазину Perfume." +
                    "Будь ласка, пройдіть за посиланням http://%s/activate/%s",
                    user.getUsername(),
                    hostname,
