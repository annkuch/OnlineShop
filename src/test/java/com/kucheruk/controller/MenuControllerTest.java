...
public class MenuControllerTest {
    ...
    public void findByPerfumerTest() throws Exception {
        ...
        Assertions.assertEquals("Dior", perfumeService.findByPerfumer(perfume.getPerfumer(), pageable)
    ...
    public void findByPerfumeGenderTest() throws Exception {
        ...
        Assertions.assertEquals("мужской", perfumeService.findByPerfumeGender(perfume.getPerfumeGender(), pageable)
    ...
    public void searchByParametersTest() throws Exception {
        ...
        assertNotNull(perfumes);
        Assertions.assertEquals(1000, perfumeService.findByPriceBetween(900, 1100, pageable)
                .getContent().get(0).getPrice());
        Assertions.assertEquals("Dior", perfumeService.findByPerfumerIn(Collections.singletonList(perfumes.get(0).getPerfumer()), pageable)
                .getContent().get(0).getPerfumer());
